...
DEPARTMENT_CATEGORIES = [
    ...
    "Риск, комплаенс и контроль",
    "Финансы, отчётность и стратегия",
    "IT, данные и цифровые продукты",
    "Маркетинг, продуктовый блок и клиентский опыт",
    "Административные и сервисные функции",
    "HR, обучение и корпоративная культура",
    "Безопасность и защита информации",
    "Операционный блок",
    "Корпоративный бизнес (юрлица)",
    "Розничный бизнес (физлица)",
